...
import type { Catalog, ClickEvent, Marketplace, RecommendationEvent } from "@/lib/types";
...
export function DevMetrics({ marketplace, catalog, recommendationEvents, clickEvents }: DevMetricsProps) {
  return (
